...
from telefonodipendente.AggiungiTelefonoDipendente import AggiungiTelefonoDipendente
from telefonodipendente.ModificaTelefonoDipendente import ModificaTelefonoDipendente


class TelefonoDipendente(QDialog):
    def __init__(self):
        super(TelefonoDipendente, self).__init__()
        loadUi("telefonodipendente/telefonodipendente2.ui",self)
        self.tableWidget.setEditTriggers(self.tableWidget.NoEditTriggers)
        self.tableWidget.setHorizontalHeaderLabels(["Telefono","Dipendente"])
    ...
    def goto_aggiungi(self):
        add = AggiungiTelefonoDipendente()
    ...
    def goto_modifica(self):
        try:
            ...
            self.mod = ModificaTelefonoDipendente(self.selected)
    ...
    def funz_cancella(self):
        try:
            ...
            if reply == QMessageBox.Yes:
                ...
                query2 = "DELETE FROM `telefonodipendente` WHERE `telefonodipendente`.`Numero` = '" + tel_sel.__str__()+ "';"
